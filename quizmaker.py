...
def edit_set_two():
	...
	ANSWER[int(current_question)-1]=a
	push_qa()
...
def create_new():
	global current_test
	print("""
	This will create a new set of test files.
	After you give the test a name, use the 
	edit existing choice to begin editing the 
	new test.
	""")
	current_test=input("What would you like to name the test? ")
	push_qa()
